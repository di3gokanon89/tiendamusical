...
public class PayPalCreateOrder extends PayPalClient {
	...
	private OrderRequest generarCuerpoOrden(SessionBean sessionBean) {
		...
		ApplicationContext applicationContext = new ApplicationContext().brandName("DevPredator INC.")
		...
		shippingDetail.addressPortable(new AddressPortable().addressLine1("MI CALLE 9")
															.addressLine2("MI COLONIA")
															.adminArea1("MÉXICO")
															.adminArea2("MONTERREY")
															.postalCode("55555")
															.countryCode("MX"));
